...
const MyBookings = () => {
  ...
  return !isLoading ? (
    <div className='reslative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh]'>
                ...
                <div className='flex flex-col p-4'>
                  ...
                  <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
                    <div className='flex items-center gap-4'> 
                      ...
                      {!item.isPaid && <button className='text-sm rounded-full font-medium 
                      bg-primary px-4  py-1.5 mb-3 cursor-pointer'> Pay Now</button>}
                    </div>
