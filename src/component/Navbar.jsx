...
const Navbar = () => {
  ...
  return (
    ...
    px-6 lg:px-36 md:px-16 py-5'>
      <Link to='/' className='max-md:flex-1'>
      <img src={assets.logo} alt=""  className='w-34 h-auto '/>
      </Link>

        <div className={`max-md:absolute max-md:top-0 max-md:left-0  max-md:font-medium
        max-md:text-lg z-50 flex flex-col md:flex-row items-center max-md:justify-center 
        gap-8 py-3 max-md:h-screen min-md:rounded-full min-md:px-8 backdrop-blur bg-black/70 
       md:bg-white/10  md:border border-gray-300/20 overflow-hidden transition-[width] duration-300 
        ...
        <SearchIcon className='max-md:hidden w-6 h-6 cursor-pointer'/>
            ...
            !user ? (
                 ...
                 <button onClick={openSignIn} className='px-4  py-1 sm:px-7 sm:py- bg-primary hover:bg-primary-dull
